...
replace (
	...
	k8s.io/endpointslice => k8s.io/kubernetes/staging/src/k8s.io/endpointslice v0.36.1
	k8s.io/externaljwt => k8s.io/kubernetes/staging/src/k8s.io/externaljwt v0.36.1
